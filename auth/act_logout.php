...
$cookie_path = "/rt_pintar/"; // Must match the path used when setting the cookie
$cookie_domain = ""; // local
...
setcookie($cookie_name, "", time() - 3600, "/rt_pintar/", $cookie_domain, false, true);
...
header("Location: /rt_pintar/auth/main.php?page=login"); // local
